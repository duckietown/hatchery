...
fun getPackages(project: Project): List<RosPackage> {
    val log = Logger.getInstance("#org.duckietown.hatchery.achdjian.utils.getPackages.${project.name}")
...
fun getEnvironmentVariables(project: Project, env: Map<String, String>): Map<String, String> {
    val log = Logger.getInstance("#org.duckietown.hatchery.achdjian.utils.getEnvironmentVariables.${project.name}")
...
fun getEnvironment(basePath: Path, setupFile: String, env: Map<String, String> = emptyMap()): Map<String, String> {
    val log = Logger.getInstance("#org.duckietown.hatchery.achdjian.utils.getEnvironment")
