package org.duckietown.hatchery.achdjian.settings

import com.intellij.openapi.diagnostic.Logger
import org.duckietown.hatchery.achdjian.utils.getEnvironment
import java.io.File
import java.nio.file.Path

fun findInitCmd(path: String): InitWorkspaceCmd? {
    val log = Logger.getInstance("#org.duckietown.hatchery.achdjian.settings.RosSettingsUtils.findInitCmd")
    return path.split(":")
...
fun diffEnvironment(rosVersion: Path): Map<String, String> {
    val log = Logger.getInstance("#org.duckietown.hatchery.achdjian.settings.RosSettingsUtils.diffEnvironment")
